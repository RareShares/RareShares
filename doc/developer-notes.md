...
RareShares Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as RareShares Core, where everyone uses
...
pay attention to for reviewers of RareShares Core code.

General RareShares Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: RareShares Core uses tinyformat, which is type safe. Leave them out to avoid confusion
