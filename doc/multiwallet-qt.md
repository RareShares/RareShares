...
Only requiring some minor changes is rareshares.cpp.
...
Changes to rareshares.cpp
----------------------
rareshares.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
