...
This mechanism has been integrated into Bitcore-Node-RareShares which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/raresharescoin/insight-api-rareshares#web-socket-api](https://github.com/raresharescoin/insight-api-rareshares#web-socket-api) 
* API: [https://github.com/raresharescoin/insight-api-rareshares#instantsend-transactions](https://github.com/raresharescoin/insight-api-rareshares#instantsend-transactions) 
...
By default, the RareShares Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the RareShares Core daemon:
