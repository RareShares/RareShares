...
This document provides guidelines for internationalization of the RareShares Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to RareShares network</numerusform>
            <numerusform>%n active connections to RareShares network</numerusform>
        </translation>
    </message>
