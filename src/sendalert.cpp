...
2. run raresharesd with -printalert or -sendalert like this:
   /path/to/raresharesd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.rareshares.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/RareShares Core:0.12.0.58/"));
