...
{
    if(fLiteMode) return; // ignore all RareShares related functionality
...
/*
    ...
    allow endless transaction that would bloat RareShares and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("rareshares-privatesend");
