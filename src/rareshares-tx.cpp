...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("RareShares Core rareshares-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rareshares-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rareshares transaction") + "\n" +
              "  rareshares-tx [options] -create [commands]   " + _("Create hex-encoded rareshares transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rareshares transaction
