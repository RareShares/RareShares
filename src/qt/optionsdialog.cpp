    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("RS-light"), QVariant("light"));
    ui->theme->addItem(QString("RS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("RS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("RS-traditional"), QVariant("trad"));
