    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("RareShares Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RareShares address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rareshares: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About RareShares Core"), this);
    aboutAction->setStatusTip(tr("Show information about RareShares Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for RareShares Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RareShares addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RareShares addresses"));
    ...
    openAction->setStatusTip(tr("Open a rareshares: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the RareShares Core help message to get a list with possible RareShares Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("RareShares Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RareShares network", "", count));
}
...
{
    QString strTitle = tr("RareShares Core"); // default title
    ...
    // Append title to "RareShares Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
