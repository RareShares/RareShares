    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("RareShares Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About RareShares Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  rareshares-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the RareShares in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 RS, 0.1 RS, 1 RS and 10 RS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://raresharescoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://raresharescoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("RareShares Core is shutting down...") + "<br /><br />" +
