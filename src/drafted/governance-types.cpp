...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "RareSharesNetwork") type = RareSharesNetwork;
    if(strType == "RareSharesNetworkVariable") type = RareSharesNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == RareSharesNetwork) s = "RareSharesNetwork";
    if(type == RareSharesNetworkVariable) s = "RareSharesNetworkVariable";
