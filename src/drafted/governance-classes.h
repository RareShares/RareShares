 ...
 *
 *   // network
 *   CRareSharesNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.rareshares.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CRareSharesNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CRareSharesNetwork(UniValue objIn)
    {
...
// // can be under: RareSharesNetwork
// //   -- signature requirements : Key1(User)
// class CRareSharesNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == RareSharesNetwork);
//     // }
